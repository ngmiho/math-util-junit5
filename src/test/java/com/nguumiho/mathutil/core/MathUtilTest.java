 ...
 */
package com.nguumiho.mathutil.core;

import static com.nguumiho.mathutil.core.MathUtil.getFactorial;
...
//    }
    ...
    //@Test(expected = tên ngoại lệ.class) JUnit4 hoy, JUnit5 hok làm vậy
    
    @Test
    public void testGetFactorialGivenWrongArgThrowException() {
        //xài biểu thức lambda
        //hàm nhận tham số thứ 2 là 1 cái object/có code implement cái
        //functional interface tên là Executable - có 1 hàm duy nhât ko code
        //tên là execute()
        //chơi chậm
